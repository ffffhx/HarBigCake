    ...
    <div class="materialContainer">
        ...
        <div class="materialMain">
            <div class="manageLeft">
                <div class="lookPositions" id="lookPositions" :style="{ width: '400px', height: '400px' }"></div>
...
onMounted(() => {
    ...
    document.getElementById('lookPositions').setAttribute('_echarts_instance_', '');
});
</script>
